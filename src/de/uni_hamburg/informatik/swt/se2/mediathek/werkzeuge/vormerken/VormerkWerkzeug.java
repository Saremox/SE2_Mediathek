...
public class VormerkWerkzeug
{
    ...
    private boolean istVormerkenMoeglich()
    {
        ...
        if(medien == null || kunde == null || medien.isEmpty())
        {
        	return false;
        }
        return _verleihService.istVormerkenMoeglich(kunde, medien);
    }
    ...
    private void merkeAusgewaehlteMedienVor()
    {
        ...
        _verleihService.vormerken(selectedKunde, selectedMedien);
    }
